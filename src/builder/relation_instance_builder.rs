...
impl RelationInstanceBuilder {
    ...
    pub fn property<'a, S: Into<String>>(&'a mut self, property_name: S, value: Value) -> &'a mut RelationInstanceBuilder {
        self.properties.insert(property_name.into(), value);
        self
    }

    pub fn create<'a>(&'a mut self, relation_edge_manager: Arc<dyn RelationInstanceManager>) -> Result<EdgeKey, RelationInstanceCreationError> {
